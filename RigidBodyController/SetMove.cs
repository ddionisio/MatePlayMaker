...
namespace M8.PlayMaker.RigidBodyControllerLib {
    ...
    [Tooltip("Set either or both the forward and side move scale of the RigidBodyController. Normally you want it either 0 or 1, such that it moves based on the force value.")]
